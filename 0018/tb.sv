...
// Golden model - pure combinational logic
always @(*) begin
    expected_out = {ONE_HOT_W{1'b0}};  // Initialize to all zeros
    if (bin_i < ONE_HOT_W) begin
        expected_out[bin_i] = 1'b1;    // Set the bit at bin_i position
    end
end
